...
(function (scenes) {
    ...
    var Level2 = (function (_super) {
         ...
         * @return void
         */
        Level2.prototype.addGreenPlatform = function () {
            // Platform Object
         ...
         * @return void
         */
        Level2.prototype.addBluePlatform = function () {
            // Platform Object
            this.platformGeometry = new BoxGeometry(10, 1, 10);
         ...
         * @return void
         */
        Level2.prototype.addYellowPlatform = function () {
            // Platform Object
            this.platformGeometry = new BoxGeometry(10, 1, 10);
         ...
         * @return void
         */
        Level2.prototype.addCyanPlatform = function () {
            // Platform Object
            this.platformGeometry = new BoxGeometry(10, 1, 10);
         ...
         * @return void
         */
        Level2.prototype.addMagentaPlatform = function () {
            // Platform Object
            this.platformGeometry = new BoxGeometry(10, 1, 10);
         ...
         * @return void
         */
        Level2.prototype.addRedPlatform = function () {
            // Platform Object
            this.platformGeometry = new BoxGeometry(10, 1, 10);
         ...
         * @return void
         */
        Level2.prototype.addTeleportalWalls = function () {
            // Teleportal Object          
         ...
         * @return void
         */
        Level2.prototype.addObstaclePlatform = function () {
            // Platform Object
        ...
        Level2.prototype.reduceTimer = function () {
            var self = this;
            if (!this.waitTime) {
                this.waitTime = true;
                setTimeout(function () {
        ...
        Level2.prototype.randomLocation = function () {
        ...
        Level2.prototype.showLevel = function (timer) {
            var self = this;
